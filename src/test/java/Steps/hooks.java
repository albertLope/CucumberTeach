...
import Utilities.WriteInExcel2;
...
public class hooks {
    ...
    public void after(Scenario scenario){
        ...
        TakesScreenshot ScreenShot = ((TakesScreenshot) DriverClassCopy.getDriver());
...
//        }
        ...
        WriteInExcel2.excelWriteResults("src\\test\\java\\excelFiles\\results.xlsx", "Sheet1",scenario);

        DriverClassCopy.quitDriver();
